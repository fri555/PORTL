...
const wizardStepLabels = ['基本信息', 'Prompt与路由', '绑定能力', '欢迎语设置', '预览提交']
          ...
          <div class="relative w-full max-w-2xl rounded-2xl bg-white shadow-2xl max-h-[90vh] flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-6">
              ...
              <div v-if="wizardStep === 2" class="space-y-4">
                <p class="text-sm text-zinc-500">配置智能体的系统提示词；具体模型由后台根据场景自动路由。</p>
                <div>
                ...
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
                  <div class="text-sm font-medium text-zinc-800">模型自动路由</div>
                  <p class="mt-1 text-xs leading-5 text-zinc-500">
                    用户侧不展示模型选择。发布后系统会根据智能体类型、任务复杂度、成本和可用性自动选择合适模型，并在后台记录调用日志。
                  </p>
                </div>
              </div>
              ...
              <div v-if="wizardStep === 5" class="space-y-4">
                ...
                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-5 space-y-3">
                  ...
                  <div class="grid grid-cols-2 gap-2 text-xs">
                    <div><span class="text-zinc-400">模型：</span><span class="text-zinc-700">后台自动路由</span></div>
