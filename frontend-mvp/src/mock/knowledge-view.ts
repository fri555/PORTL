/**
 * knowledge-view.ts — 知识中心 mock 数据（与 types/knowledge.ts 对齐）
 * 提取自 KnowledgeBaseView.vue 内联数据，方便后续替换为真实 API 调用
 */
...
export const allDocs: Record<string, DocItem[]> = {
  ...
  'kb-public-3': [
    { name: '运动鞋团购成功案例.md', format: 'MD', status: '已索引', updatedAt: '2026-06-26', uploadedBy: '方案中心张明', tags: ['案例'] },
    { name: '团购通用预算池.xlsx', format: 'XLSX', status: '已索引', updatedAt: '2026-06-24', uploadedBy: '方案中心张明', tags: ['预算'] },
    { name: '方案中心字段模板.xlsx', format: 'XLSX', status: '解析中', updatedAt: '2026-06-22', uploadedBy: '方案中心李娟', tags: ['模版'] },
    { name: 'B2B团购方案模板.docx', format: 'DOCX', status: '已索引', updatedAt: '2026-06-15', uploadedBy: '方案中心王磊', tags: ['模版', '团购'] },
    { name: 'B2C团购方案模板.docx', format: 'DOCX', status: '已索引', updatedAt: '2026-06-14', uploadedBy: '方案中心李娟', tags: ['模版', '团购'] },
  ],
  'kb-public-4': [
    { name: '2026Q1预算执行表.xlsx', format: 'XLSX', status: '已索引', updatedAt: '2026-06-20', uploadedBy: '方案中心张明', tags: ['预算'] },
    { name: '价格带分析报告.docx', format: 'DOCX', status: '已索引', updatedAt: '2026-06-18', uploadedBy: '方案中心王磊', tags: ['分析'] },
  ],
  'kb-public-5': [
