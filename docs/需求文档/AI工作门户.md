...
> **最新口径提示（2026-06-25）**：本文为早期门户完整蓝图，保留作长期规划参考。AI中台第一期 MVP 已收敛为“首页搜索/任务输入 + 全屏对话工作台 + 方案中心主管 + 基础权限管理”，不包含需求池、能力市场、文化资讯、价值看板等完整门户模块。第一期范围以 `AI工作门户-MVP规划.md` 与 `AI工作门户-一期MVP技术方案.md` 为准。
